...
Please send me the QuickBooks invoice.`
  ...
  const cardStyle = useMemo(() => {
    switch (selectedColor.toLowerCase()) {
      case "violet":
        return {
          background: "linear-gradient(135deg, #35145b 0%, #6b36b9 55%, #b07cff 100%)",
          color: "#ffffff",
          border: "rgba(223,205,255,.38)",
          glow: "rgba(155, 101, 255, .35)",
        };
      case "black":
        return {
          background: "linear-gradient(135deg, #0b0d12 0%, #1a1f2c 55%, #313949 100%)",
          color: "#ffffff",
      ...
      case "green":
        return {
          background: "linear-gradient(135deg, #103624 0%, #1e7850 55%, #4bc98d 100%)",
          color: "#ffffff",
          border: "rgba(181,255,218,.26)",
          glow: "rgba(75, 201, 141, .26)",
        };
      case "blue":
        return {
          background: "linear-gradient(135deg, #0a2b62 0%, #1552c8 55%, #62a7ff 100%)",
          color: "#ffffff",
          border: "rgba(187,221,255,.28)",
          glow: "rgba(98, 167, 255, .28)",
        };
      case "red":
        return {
          background: "linear-gradient(135deg, #4f0f18 0%, #b42036 55%, #f35c70 100%)",
          color: "#ffffff",
          border: "rgba(255,197,204,.24)",
          glow: "rgba(243, 92, 112, .24)",
        };
      case "rose gold":
        return {
          background: "linear-gradient(135deg, #6f473f 0%, #bd7c70 55%, #f1c8c0 100%)",
          color: "#fffaf8",
          border: "rgba(255,232,226,.28)",
          glow: "rgba(241, 200, 192, .24)",
        };
      case "golden bronze":
        return {
          background: "linear-gradient(135deg, #5b3b1b 0%, #ab742f 55%, #dfb97e 100%)",
          color: "#fffaf2",
          border: "rgba(255,229,189,.24)",
          glow: "rgba(223, 185, 126, .24)",
        };
      case "silver":
        return {
          background: "linear-gradient(135deg, #838b96 0%, #d9dfe7 55%, #fbfdff 100%)",
          color: "#101827",
    ...
    <main className="pageBg">
        ...
        <section className="hero">
          ...
          <div className="heroRight">
            <div
              className="cardGlow"
              style={{
                background: `radial-gradient(circle, ${cardStyle.glow} 0%, transparent 72%)`,
              }}
            />
            <div
      ...
      <style jsx>{`
        ...
        .cardPreview {
          ...
          transform: translateY(230px) perspective(1200px) rotateX(8deg) rotateY(-10deg);
          transition: transform 0.28s ease, box-shadow 0.28s ease;
          z-index: 3;
        }

        .cardPreview:hover {
          transform: translateY(218px) perspective(1200px) rotateX(5deg) rotateY(-6deg);
          box-shadow:
